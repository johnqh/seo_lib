 ...
 *
 * Reads app-level config from `SEOHeadProvider`, derives canonical URL and
 * language from the current route, builds the WebApplication schema, and
 * delegates all DOM manipulation to `usePageSEO`.
 *
